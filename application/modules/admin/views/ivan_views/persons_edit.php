...
<?php echo form_hidden('id',$result->id) ?>
                                    ...
                                    <input id="relationship_id" type="text" name="relationship_id" value="<?php echo $result->relationship_id ?>"  />
                                    <?php echo form_error('relationship_id','<div>','</div>'); ?>
                                    </p>
                                    

                                    <p><label for="slug">Slug<span class="required">*</span></label>                                
                                    <input id="slug" type="text" name="slug" value="<?php echo $result->slug ?>"  />
                                    <?php echo form_error('slug','<div>','</div>'); ?>
                                    </p>
                                    

                                    <p><label for="first_name">First_name<span class="required">*</span></label>                                
                                    <input id="first_name" type="text" name="first_name" value="<?php echo $result->first_name ?>"  />
                                    <?php echo form_error('first_name','<div>','</div>'); ?>
                                    </p>
                                    

                                    <p><label for="last_name">Last_name<span class="required">*</span></label>                                
                                    <input id="last_name" type="text" name="last_name" value="<?php echo $result->last_name ?>"  />
                                    ...
                                    <input id="institutional_affiliation" type="text" name="institutional_affiliation" value="<?php echo $result->institutional_affiliation ?>"  />
                                    ...
                                    <input id="departmental_affiliation" type="text" name="departmental_affiliation" value="<?php echo $result->departmental_affiliation ?>"  />
                                    ...
                                    <input id="pw_salt" type="text" name="pw_salt" value="<?php echo $result->pw_salt ?>"  />
                                    <?php echo form_error('pw_salt','<div>','</div>'); ?>
                                    </p>
                                    

                                    <p><label for="pw_hash">Pw_hash</label>                                
                                    <input id="pw_hash" type="text" name="pw_hash" value="<?php echo $result->pw_hash ?>"  />
