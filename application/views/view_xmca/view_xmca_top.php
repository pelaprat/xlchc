...
function searchWidget($words, $mode, $simplehtml, $date_start, $date_end){
    ...
    $ret .= "    <form id='xmca_search_form' action='exp_xmca' method='get'>";
    ...
    $ret .= "    <div style='float:right'><div class='xmca_search_form_element'><a href='/exp_xmca'>Recent Threads</a></div></div>";
...
function prettyPagination($words, $total, $matches, $index_start, $mode, $simplehtml, $resultPromt){
    $aBegin = "<a href='/exp_xmca?words=" . implode(array_keys($words), '%20') . "&simplehtml=$simplehtml&mode=$mode&index_start=";
